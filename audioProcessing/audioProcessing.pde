...
void draw() {    
    ...
    for(int i = 250; i < song.left.size() - 1; i++) {
      ...
      noStroke();
      fill(255,fft.getBand(i)*100,0);
      ellipse(500,100,song.mix.get(i)*1000,song.left.get(i+1)*1000);
      fill(100+song.mix.get(i+1)*50,song.mix.get(i)*50,200+song.left.get(i+1)*100);
      //rect(song.left.get(i+1)*100,100+song.left.get(i+1)*100,800+song.left.get(i+1)*100,800);
      fill(song.mix.get(i)*50,255,song.mix.get(i)*500);
      ellipse(200+song.mix.get(i)*50,100+song.mix.get(i)*500,song.mix.get(i)*100,song.left.get(i+1)*100);
      stroke(#FF0000);
      rect(500,500+song.mix.get(i)*50,song.mix.get(i)*1000,100+song.mix.get(i)*50);
      stroke(#FF0000);
      rect(600,300+fft.getBand(i)*4,song.mix.get(i)*1000,100+song.mix.get(i)*50);
    }
